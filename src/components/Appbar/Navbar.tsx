  ...
  return (
    ...
    >
      ...
      <Appbar
        title="MMDEV_STUDIO"
        navItems={[
          { href: sections.identity.href, name: "identity" },
          { href: sections.products.href, name: "products" },
          { href: sections.showcase.href, name: "showcase" },
          { href: sections.contact.href, name: "build now" },
        ]}
        isNav
      />
    </div>
